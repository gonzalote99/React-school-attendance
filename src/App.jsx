...
import GirlLsit from './GirlsList';
...
function App() {
  ...
  const handleSubmit = (e) => {
    ...
    if(gender === "girl") {
      const girlsId = girls.length ? girls[girls.length-1].id + 1: 1;
      const girlsRollNumber = girlsId + 1000;
  ...
  return(
    ...
    students attendance
      ...
      <AddStudent firstName={firstName} lastName={lastName} gender={gender} setFirstName={setFirstName} setLastName={setLastName} setGender={setGender} handleSubmit={handleSubmit} />
      </div>
        <div className='studentList'>
        <BoysList boys={boys} setBoys={setBoys} handleDeleteBoys={handleDeleteBoys} />
          <GirlLsit girls={girls} handleDeleteGirls={handleDeleteGirls} setGirls={setGirls} />
        </div>
      </div>
      <Footer />
